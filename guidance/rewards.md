...
| `PickScore_TextImage_Sum` | Pointwise | Text+image CLIP similarity sum over video frames; requires `video` + `condition_images` | [PickScore](https://huggingface.co/yuvalkirstain/PickScore_v1) |
